...
namespace WpfMvvmApp.ViewModels
{
    public class ShellViewModel : ViewModelBase
    {
        ...
        string outAdult;
        string outBirthday;
        string outChnZodiac;    // 200727 16:43 신규 추가
        string outZodiac;       // 200727 17:01 신규 추가
        ...
        public string InLastName
        {
            ...
            {
                inLastName = value;
                RaisePropertyChanged("InLastName"); // RaisePropertyChanged 속성값이 변경될때 자동으로 바인딩소스{binding ~~} 에 알리도록 설정한다.
            }
        }
        ...
        public string OutChnZodiac  //  2007 16:44 신규추가 : 띠추가
        {
            get => outChnZodiac;
            set
            {
        ...
        public string OutZodiac  //  2007 16:44 신규추가 : 띠추가
        {
            get => outZodiac;
            set
            {
        ...
        (o => Click(), o => IsClick())); // o => Click(생성자 람다식)
        ...
        private void Click()
        {
            try
            {
                ...
                OutChnZodiac = person.ChnZodiac;    // 20200727 추가 
